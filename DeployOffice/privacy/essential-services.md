...
Телеметрія використання, яка дає змогу дізнатися, коли користувач натискає кнопку "Переглянути всі переваги", щоб після успішного придбання переглянути програми та функції, які входять до щойно зробленої покупки. Ці дані використовуються, щоб забезпечити майбутні вдосконалення, пов’язані з мінімізацією переривання роботи користувачів під час оновлення програми.
