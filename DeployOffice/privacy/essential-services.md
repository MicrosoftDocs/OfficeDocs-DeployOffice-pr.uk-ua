...
- **Result** – прапори кодів числових помилок, які повертають API-інтерфейси виклику веб-служб Office.
...
- **ActionCreateAccount** - користувач вирішив створити обліковий запис.

- **ActionSignIn** - користувач вирішив виконати вхід.

- **DialogRedemption** - відображення вікна активації AFO.

- **DialogSignIn** - відображення діалогового вікна входу AFO.
...
- **InAppTrialPurchase** - вказує, чи ввімкнуто тестову можливість для запуску пакета SDK для придбання з магазину, щоб отримати PI, і придбати ознайомлювальну версію з програми.
...
- **StoreErrorConditions** - вказує на різні умови, при яких може виникати помилка придбання пакету SDK з магазину.

- **StoreErrorHResult** - вказує код помилки, який повертається при придбанні пакета SDK з магазину

- **StorePurchaseStatusResult** – повідомляє про результат виклику функції придбання пакету SDK з магазину, а також про те, чи зробив покупку користувач, що допоможе нам визначити, чи користувачу треба отримувати ліцензію на використання Office

- **Tag** - використовується, щоб вказати місце в коді, з якого було надіслано подію

- **UserSignedInExplicitly** - указує, чи користувач увійшов явно, і, якщо так, ми могли переспрямовувати користувачів до Інтернету для отримання ознайомлювальної версії.
