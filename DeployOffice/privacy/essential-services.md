...
Ця подія використовується для записування подій для кількісного оцінювання впливу помилки, через яку користувачі сьогодні бачать Null-значення, а не ціну на екрані вибору облікових номерів. Помилку буде продіагностовано докладніше, щоб визначити виправлення. 
...
Ця подія допомагає відстежувати використання запуску наради в календарі в різних кінцевих точках. Ця подія дає змогу виявляти дві речі: коли нарада запуститься через Skype для бізнесу і через Teams, якщо програму Teams інстальовано.
