...
|Рекомендації щодо діаграм|[Створення діаграми за допомогою рекомендованих діаграм](https://support.microsoft.com/office/cd131b77-79c7-4537-a438-8db20cea84c0)|
...
| Перетворення рукопису на текст, перетворення рукописного фрагмента на фігури, перетворення рукописного виразу на рівняння<sup>2</sup> | [PowerPoint для Microsoft 365 дає змогу перетворити рукописні фрагменти на фігури, текст або математичні вирази](https://support.microsoft.com/office/0740dec3-6291-4c1f-8baa-011d18449919) |
...
|Рекомендації щодо зведених таблиць|[Створення зведеної таблиці для аналізу даних аркуша](https://support.microsoft.com/office/a9a84538-bfe9-40a9-a8e9-f99134456576)|
...
| Пропоновані відповіді | [Використовуйте пропозиції відповідей в Outlook](https://support.microsoft.com/office/19316194-0434-43ba-a742-6b5890157379)|
...
<sup>2</sup> Для пристроїв з Android ці можливості рукописного вводу залишаються доступними, навіть якщо ви не підключені до Інтернету. Ці можливості рукописного вводу також залишаються доступними на пристроях з Android, навіть якщо ви вирішите вимкнути використання підключених можливостей, які аналізують ваш вміст. В обох випадках дані про використання можливостей рукописного вводу не надсилаються до корпорації Майкрософт.
...
| Допомога<sup>3</sup>    | [Пришвидшення роботи завдяки функції «Допомога»](https://support.microsoft.com/office/f20d2198-17b8-4b09-a3e5-007a337f1e4e)  |
...
<sup>3</sup> Основні функціональні можливості Допомоги залишаються доступними, навіть якщо ви не підключені до Інтернету. Вони також залишатимуться доступними, якщо ви вирішите вимкнути використання підключених можливостей, які завантажують вміст з Інтернету. В обох випадках дані про використання Допомоги не надсилаються до корпорації Майкрософт.
